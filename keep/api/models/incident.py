...
class IncidentDto(IncidentDtoIn):
    ...
    model_config = ConfigDict(
        ...
        # underscore_attrs_are_private removed in Pydantic v2, use PrivateAttr instead
        # json_encoders removed in Pydantic v2 - UUID serialization is handled automatically
    )
    ...
    def from_db_incident(cls, db_incident: "Incident", rule: "Rule" = None):
        ...
        dto = cls(
            ...
            incident_application=str(db_incident.incident_application) if db_incident.incident_application else None,
            enrichments=db_incident.enrichments or None,
        ...
        if db_incident.enrichments:
            dto = dto.model_copy(update=db_incident.enrichments)
