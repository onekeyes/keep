    ...
    <>
            ...
            <Disclosure.Panel as="ul" className="space-y-0.5 p-1 pr-1">
              {shouldShowFeed && (
                <li>
                  ...
                  >
                    <Subtitle className="text-xs">{t('navigation.feed')}</Subtitle>
                  </LinkWithIcon>
                </li>
              )}
      ...
      >
        <div className="space-y-2">
          <Subtitle>{t('titles.selectTagsToWatch')}</Subtitle>
          <Callout title="" color="orange">
            {t('messages.customizePresets')}
          </Callout>
          <CreatableMultiSelect
            ...
            placeholder={t('placeholders.selectOrCreateTags')}
            className="mt-4"
          />
